...
@section('title', $catalog['seo']['title'] ?? 'Portfolio')
...
@push('head')
    ...
    @endif
    <meta property="og:title" content="{{ $catalog['seo']['title'] ?? 'Portfolio' }}">
    ...
    <main id="main-content">
        <section class="cyra-page-hero">
            ...
            <div class="cyra-container relative cyra-section-hero-inner">
                ...
                @endif
                <h1 class="mt-3 cyra-display">{{ $hero['title'] ?? 'Portfolio' }}</h1>
        ...
        <section class="cyra-section" aria-labelledby="portfolio-catalog-title">
            <div class="cyra-container">
                <x-ui.section-heading
                    eyebrow="Case Studies"
                    title="Enterprise programs with measurable outcomes"
                    id="portfolio-catalog-title"
                    class="cyra-section-heading"
                />

                <div class="mb-8 flex flex-wrap gap-2" role="tablist" aria-label="Filter case studies by category">
                ...
                <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3" data-portfolio-grid>
        ...
        <section class="cyra-section cyra-section-soft border-t border-cyra-border" aria-labelledby="portfolio-impact-title">
            <div class="cyra-container">
                <x-ui.section-heading
                    :eyebrow="$impact['eyebrow'] ?? null"
                    :title="$impact['title'] ?? ''"
