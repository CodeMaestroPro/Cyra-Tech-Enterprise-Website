...
@section('content')
    ...
    <main id="main-content">
        ...
        <section class="py-16" aria-labelledby="products-catalog-title">
        ...
        <section class="border-t border-cyra-border/60 bg-cyra-navy/20 py-16" aria-labelledby="products-ecosystem-title">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <x-ui.section-heading
