...
@section('title', $catalog['seo']['title'] ?? 'Industries')
...
@push('head')
    ...
    @endif
    <meta property="og:title" content="{{ $catalog['seo']['title'] ?? 'Industries' }}">
    ...
    <main id="main-content">
        ...
        <section class="py-16" aria-labelledby="industries-catalog-title">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3" data-industry-grid>
                    @foreach ($verticals as $vertical)
                        <x-industries.vertical-card :vertical="$vertical" />
                    @endforeach
                </div>
            </div>
        </section>
