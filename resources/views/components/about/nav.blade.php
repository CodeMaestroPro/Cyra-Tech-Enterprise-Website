...
<nav aria-label="About section navigation" class="border-b border-cyra-border/80 bg-cyra-soft/80 backdrop-blur-sm">
                ...
                <li class="shrink-0">
                    <a
                        ...
                        @class([
                            ...
                            'text-cyra-muted hover:bg-cyra-light/60 hover:text-cyra-text' => ! $item['active'],
                        ])
