/**
 * Industries page — category filter for industry vertical cards.
 */
export function initIndustriesPage() {
    const filters = document.querySelectorAll('[data-industry-filter]');
    ...
    const applyFilter = (category) => {
        cards.forEach((card) => {
            const matches = category === 'all' || card.dataset.industryCategory === category;
