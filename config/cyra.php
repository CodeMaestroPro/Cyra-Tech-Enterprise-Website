...
return [
    ...
    'homepage' => [
        ...
        'sections' => [
            ...
            [
                ...
                'title' => 'Practical software. Real impact.',
                'description' => 'From custom apps to operations, commerce, and education systems — Cyra-Tech builds software that helps organizations work smarter every day.',
                'content' => [
                    'items' => [
                        ['title' => 'Custom Software', 'description' => 'Web, mobile, and tailored business systems built around how your team actually works.', 'route' => 'solutions.show', 'route_params' => ['slug' => 'custom-software-development'], 'icon' => 'transform'],
                        ['title' => 'Operations Systems', 'description' => 'Inventory, sales, purchases, and branch visibility for clearer daily business control.', 'route' => 'solutions.show', 'route_params' => ['slug' => 'operations-inventory-systems'], 'icon' => 'retail'],
                        ['title' => 'Hospitality Systems', 'description' => 'Hotel and property tools for rooms, bookings, staff, and revenue in one place.', 'route' => 'solutions.show', 'route_params' => ['slug' => 'hospitality-hotel-systems'], 'icon' => 'managed'],
                        ['title' => 'Commerce Platforms', 'description' => 'Marketplace and installment commerce experiences with clear payment tracking.', 'route' => 'solutions.show', 'route_params' => ['slug' => 'commerce-marketplace-platforms'], 'icon' => 'finance'],
                        ['title' => 'Agribusiness Channels', 'description' => 'Farm-to-buyer digital platforms that connect producers with customers.', 'route' => 'solutions.show', 'route_params' => ['slug' => 'agribusiness-digital-channels'], 'icon' => 'retail'],
                        ['title' => 'Education Portals', 'description' => 'Admissions, student access, careers, and institutional websites for campuses.', 'route' => 'solutions.show', 'route_params' => ['slug' => 'education-campus-portals'], 'icon' => 'government'],
                        ['title' => 'Advisory & Delivery', 'description' => 'Discovery-to-launch partnership that bridges ideas and working software.', 'route' => 'solutions.show', 'route_params' => ['slug' => 'digital-advisory-delivery'], 'icon' => 'spark'],
                        ['title' => 'Community Impact', 'description' => 'Technology initiatives that empower youth and strengthen local communities.', 'route' => 'community', 'icon' => 'spark'],
                    ],
    ...
    */
    ...
    'solutions' => [
        'seo' => [
            'title' => 'Software Solutions | Cyra-Tech',
            'description' => 'Cyra-Tech builds practical software for organizations — custom web and mobile apps, inventory and hotel systems, commerce platforms, and education portals across Nigeria and beyond.',
            'keywords' => ['software for organizations', 'custom business systems', 'inventory management', 'hotel management', 'education portals', 'Nigeria software company', 'Cyra-Tech solutions'],
        ],
        'hero' => [
            'eyebrow' => 'Solutions',
            'title' => 'Practical software solutions for growing organizations',
            'description' => 'We design and build digital systems that help teams run operations with clarity — custom applications and ready-to-deploy products for inventory, hospitality, commerce, agribusiness, and education.',
        ],
        'categories' => [
            ['slug' => 'all', 'label' => 'All Solutions'],
            ['slug' => 'custom-software', 'label' => 'Custom Software'],
            ['slug' => 'operations', 'label' => 'Business Operations'],
            ['slug' => 'commerce', 'label' => 'Commerce'],
            ['slug' => 'education', 'label' => 'Education'],
            ['slug' => 'advisory', 'label' => 'Advisory & Support'],
        ],
        'offerings' => [
            [
                ...
                'summary' => 'Mobile, web, and tailored business systems your team can actually use.',
                'description' => 'CYRA-TECH turns ideas into functional, scalable applications. From startups launching a first product to organizations modernizing daily workflows, we build software tailored to how your people work — not generic templates that create more complexity.',
                'capabilities' => ['Web application development', 'Mobile application development', 'Custom business systems', 'Secure, responsive product delivery'],
                'outcomes' => ['Software fitted to your processes', 'Clearer day-to-day operations', 'Products ready to grow with your team'],
                'icon' => 'transform',
                'is_featured' => true,
            ],
            [
                'slug' => 'operations-inventory-systems',
                'category' => 'operations',
                'title' => 'Operations & Inventory Systems',
                'summary' => 'Stock, sales, purchases, and branch visibility in one place.',
                'description' => 'We build operations systems that help retailers, distributors, and multi-location teams monitor stock, sales, purchases, expenses, and performance with role-based access — so every staff member sees what they need for accurate daily work.',
                'capabilities' => ['Real-time stock and inventory tracking', 'Sales and purchase workflows', 'Supplier and customer records', 'Multi-branch performance visibility'],
                'outcomes' => ['Fewer stock blind spots', 'Clearer sales and purchase control', 'Faster operational decisions'],
                'icon' => 'retail',
                'is_featured' => true,
            ],
            [
                'slug' => 'hospitality-hotel-systems',
                'category' => 'operations',
                'title' => 'Hospitality & Hotel Systems',
                'summary' => 'Rooms, bookings, staff, and revenue in one dashboard.',
                'description' => 'Our hospitality solutions give managers a live view of rooms, occupancy, bookings, staff, and paid revenue. From guest-facing experiences to admin dashboards, we help hotels run smoother front-desk and property operations.',
                'capabilities' => ['Live room and occupancy tracking', 'Booking and stay management', 'Staff and user administration', 'Revenue and finance snapshots'],
                'outcomes' => ['Smoother guest experiences', 'Clearer room availability', 'Better daily hotel visibility'],
                'icon' => 'managed',
                'is_featured' => true,
            ],
            [
                ...
                'summary' => 'Installment commerce and marketplace experiences built for real buyers.',
                'description' => 'We design commerce platforms that support flexible buying, trusted marketplace flows, and clear payment tracking — including installment-style experiences that help customers own what they need while businesses stay in control of collections and progress.',
                'capabilities' => ['Flexible installment payment plans', 'Marketplace product discovery', 'Secure checkout and payment tracking', 'Affiliate-ready growth channels'],
                'outcomes' => ['Simpler buying journeys', 'Clearer payment visibility', 'Commerce flows that scale with demand'],
                'icon' => 'finance',
                'is_featured' => true,
            ],
            [
                'slug' => 'agribusiness-digital-channels',
                'category' => 'commerce',
                'title' => 'Agribusiness Digital Channels',
                'summary' => 'Farm-to-buyer platforms that connect producers and customers.',
                'description' => 'CYRA-TECH builds agribusiness and marketplace solutions that help buyers source quality produce from trusted farmers, with category-based shopping, seasonal inventory, and simple digital commerce experiences for food and farm supply.',
                'capabilities' => ['Farm-to-door product discovery', 'Trusted producer marketplace flows', 'Category and seasonal catalog support', 'Buyer-friendly commerce experiences'],
                'outcomes' => ['Shorter path from farm to buyer', 'Clearer product discovery', 'Digital channels for agribusiness growth'],
                'icon' => 'retail',
                'is_featured' => false,
            ],
            [
                'slug' => 'education-campus-portals',
                'category' => 'education',
                'title' => 'Education & Campus Portals',
                'summary' => 'Admissions, student access, careers, and institutional websites.',
                'description' => 'We deliver education platforms for universities and programmes — from admissions and pre-degree/student portals to undergraduate access, careers recruitment, and public institutional websites that present a clear academic brand.',
                'capabilities' => ['Admissions and programme entry points', 'Student and applicant portal access', 'Careers and recruitment portals', 'Institutional website experiences'],
                'outcomes' => ['Clearer applicant journeys', 'Secure student account access', 'Stronger digital campus presence'],
                'icon' => 'government',
                'is_featured' => true,
            ],
            [
                'slug' => 'digital-advisory-delivery',
                'category' => 'advisory',
                'title' => 'Digital Advisory & Delivery',
                'summary' => 'From discovery to launch — a practical partnership for shipping software.',
                'description' => 'Not every engagement starts with a finished product brief. We help organizations clarify requirements, design usable solutions, and deliver production-ready systems with continuous collaboration — bridging ideas and reality without unnecessary complexity.',
                'capabilities' => ['Discovery and requirements clarity', 'Solution design and UX direction', 'Agile build and launch support', 'Post-launch improvement guidance'],
                'outcomes' => ['Clearer project direction', 'Faster path from idea to launch', 'Software teams can rely on day to day'],
                'icon' => 'spark',
                'is_featured' => false,
            ],
        ],
        'process' => [
            ...
            'description' => 'A clear, collaborative process — from understanding your operations to launching software your team can rely on.',
            'steps' => [
        ...
        'cta' => [
            'title' => 'Need software built for how your organization works?',
            'description' => 'Tell us about your operations — inventory, hospitality, commerce, education, or a custom product. We will help shape a practical solution.',
