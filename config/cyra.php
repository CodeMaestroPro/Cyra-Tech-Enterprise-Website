    ...
    'about' => [
        'pages' => [
            [
                ...
                'title' => 'Powerful, user-focused software for modern organizations',
                'description' => 'CYRA-TECH is a forward-thinking technology company dedicated to building software solutions that solve real-world problems and drive sustainable growth.',
                'seo' => [
                    'title' => 'About Cyra-Tech | Software Solutions Company',
                    'description' => 'Learn about CYRA-TECH — a technology company building powerful, user-focused software for companies, businesses, individuals, and organizations.',
                    'keywords' => ['about Cyra-Tech', 'software solutions company', 'web and mobile development', 'custom business systems'],
                ],
                'content' => [
                    ['type' => 'prose', 'title' => 'Who we are', 'paragraphs' => [
                        'CYRA-TECH is a forward-thinking technology company dedicated to building powerful, user-focused software solutions for companies, businesses, individuals, and organizations. We specialize in turning ideas into functional, scalable applications that solve real-world problems and drive growth.',
                        'At CYRA-TECH, we combine innovation, creativity, and technical expertise to deliver high-quality digital products—from mobile and web applications to customized business systems. Whether you\'re a startup looking to launch your first product or an established organization aiming to streamline operations, we provide solutions tailored to your needs.',
                    ]],
                    ['type' => 'feature-list', 'title' => 'What we build', 'items' => [
                        ['title' => 'Mobile applications', 'description' => 'Intuitive, high-performing mobile experiences designed around real user needs and business goals.'],
                        ['title' => 'Web applications', 'description' => 'Secure, responsive web platforms that help teams operate with clarity, speed, and confidence.'],
                        ['title' => 'Custom business systems', 'description' => 'Tailored software that simplifies operations, connects workflows, and supports long-term scalability.'],
                        ['title' => 'Growth-ready products', 'description' => 'Digital products engineered to evolve with your organization—from first launch to enterprise scale.'],
                    ]],
                    ['type' => 'quote-cards', 'items' => [
                        [
                            'label' => 'Our Mission',
                            'quote' => 'To empower people and organizations through technology, making processes smarter, faster, and more efficient.',
            ...
            [
                ...
                'eyebrow' => 'Purpose',
                'title' => 'Our goal at CYRA-TECH',
                'description' => 'We exist to empower businesses, individuals, and organizations with innovative software that simplifies operations and drives sustainable growth.',
                'seo' => [
                    'title' => 'Vision & Mission | Cyra-Tech',
                    'description' => 'Discover CYRA-TECH\'s mission and goal: empowering people and organizations through reliable, scalable, user-friendly technology.',
                ],
                'content' => [
                    ['type' => 'quote-cards', 'items' => [
                        [
                            'label' => 'Mission',
                            'quote' => 'To empower people and organizations through technology, making processes smarter, faster, and more efficient.',
                            'description' => 'Technology should create clarity—not complexity. We build solutions that help people work better every day.',
                        ],
                        [
                            'label' => 'Our Goal',
                            'quote' => 'Bridge the gap between ideas and reality with reliable, scalable, and user-friendly applications.',
                            'description' => 'Every engagement is tailored to the unique needs of the client we serve.',
                        ],
                    ]],
                    ['type' => 'prose', 'title' => 'What that means in practice', 'paragraphs' => [
            ...
            [
                ...
                'nav_label' => 'Values',
                'eyebrow' => 'Core Values',
                'title' => 'The principles behind every solution we deliver',
                'description' => 'Our values guide how we design, build, and partner—so every product we ship is useful, reliable, and built for real impact.',
                'seo' => [
                    'title' => 'Core Values | Cyra-Tech',
                    'description' => 'Innovation, excellence, client focus, and impact — the values that guide CYRA-TECH.',
                ],
                'content' => [
                    ['type' => 'value-grid', 'items' => [
                        ['title' => 'Innovation', 'description' => 'We explore practical technology that solves real problems—not complexity for its own sake.'],
                        ['title' => 'Excellence', 'description' => 'We hold ourselves to high standards in design, engineering, and delivery quality.'],
                        ['title' => 'Client focus', 'description' => 'Every solution is tailored to the people and organizations we serve.'],
                        ['title' => 'Reliability', 'description' => 'We build software that teams can trust—stable, secure, and ready to scale.'],
                        ['title' => 'Impact', 'description' => 'Success means technology that improves productivity and creates measurable value.'],
                        ['title' => 'Continuous growth', 'description' => 'We keep learning, refining, and improving so our clients stay ahead.'],
                    ]],
                ],
            ],
            [
                ...
                'nav_label' => 'Our Approach',
                'eyebrow' => 'How We Work',
                'title' => 'From idea to scalable product',
                'description' => 'We follow a clear, collaborative process that turns ambition into dependable software—built for the people who use it.',
                'seo' => [
                    'title' => 'Our Approach | Cyra-Tech',
                    'description' => 'See how CYRA-TECH moves from discovery to delivery—building reliable, scalable, user-focused software.',
                ],
                'content' => [
                    ['type' => 'timeline', 'items' => [
                        ['year' => '01', 'title' => 'Discover', 'description' => 'We listen closely to understand your goals, users, constraints, and opportunities for impact.'],
                        ['year' => '02', 'title' => 'Design', 'description' => 'We shape clear product experiences and technical plans that balance usability with scalability.'],
                        ['year' => '03', 'title' => 'Build', 'description' => 'Our team develops high-quality mobile, web, and business systems with precision and care.'],
                        ['year' => '04', 'title' => 'Launch', 'description' => 'We deliver production-ready solutions and support a confident go-live for your organization.'],
                        ['year' => '05', 'title' => 'Optimize', 'description' => 'We refine performance, usability, and workflows so your product continues to create value.'],
                        ['year' => '06', 'title' => 'Scale', 'description' => 'We help your software grow with your business—adding features, capacity, and resilience over time.'],
                    ]],
                ],
            ],
            [
                ...
                'eyebrow' => 'Why Cyra-Tech',
                'title' => 'A technology partner focused on real outcomes',
                'description' => 'Whether you are launching a first product or modernizing operations, we deliver software tailored to your goals.',
                'seo' => [
                    'title' => 'Why Choose Cyra-Tech | Software Solutions Partner',
                    'description' => 'Discover why organizations choose CYRA-TECH for user-focused, scalable software solutions.',
                ],
                'content' => [
                    ['type' => 'feature-list', 'items' => [
                        ['title' => 'User-focused by design', 'description' => 'We build products people actually want to use—clear, practical, and aligned with real workflows.'],
                        ['title' => 'Tailored to your needs', 'description' => 'No one-size-fits-all templates. Every solution is shaped around your organization\'s unique requirements.'],
                        ['title' => 'End-to-end capability', 'description' => 'From mobile and web applications to customized business systems, we deliver complete digital products.'],
                        ['title' => 'Built to grow with you', 'description' => 'Our solutions are designed for reliability and scale—supporting startups and established organizations alike.'],
                    ]],
                    ['type' => 'prose', 'title' => 'Our commitment', 'paragraphs' => [
                        'At CYRA-TECH, we are committed to continuous innovation, excellence, and creating technology that makes a real impact in everyday life.',
                    ]],
                    ['type' => 'cta', 'title' => 'Let\'s shape the future together', 'description' => 'Share your vision with us. We will help turn it into a functional, scalable solution.', 'action' => ['label' => 'Contact Us', 'route' => 'contact']],
                ],
            ],
        ],
    ],
    ...
    'navigation' => [
        ...
        'public' => [
            'header' => [
                ...
                ['label' => 'Portfolio', 'route' => 'portfolio', 'sort' => 5],
                ['label' => 'Innovation Lab', 'route' => 'innovation-lab', 'sort' => 6],
            ],
            'actions' => [
