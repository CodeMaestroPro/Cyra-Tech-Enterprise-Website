...
class ProductsPageTest extends TestCase
{
    ...
    public function test_products_page_renders_catalog_and_ecosystem(): void
    {
        ...
        $response
            ...
            ->assertSee('GoldSash')
            ->assertSee('Sellpadi')
            ->assertSee('Pre-Degree Student Portal')
            ->assertSee('University Admissions Portal')
            ->assertSee('University Careers Portal')
            ->assertSee('Undergraduate Portal')
            ->assertSee('University Website')
